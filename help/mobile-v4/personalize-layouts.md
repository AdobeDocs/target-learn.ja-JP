...
エミュレータを実行し、ホーム画面の下部に表示される最初のオファーを監視します。 再訪問者が5回以上のアプリを起動した場合は、「_ようこそ_」オファーが表示されます。 新規ユーザーの場合（アプリの起動回数が5回未満）、_新規ユーザー_&#x200B;のメッセージが表示されます。
...
**[!UICONTROL 出発]**&#x200B;としてサンノゼ&#x200B;]**を、**[!UICONTROL &#x200B;出発として&#x200B;**[!UICONTROL サンディエゴ]**&#x200B;を選択し、**[!UICONTROL 目的地]**&#x200B;として&#x200B;**[!UICONTROL バス]**&#x200B;を検索します。
