...
TQID: https://experienceleague.adobe.com/oMoEagJUT3pOGphvb8dNlo-i8kUOkdYafPZ6swNeqTg
product_v2:
...
* Adobe TargetでのA/B アクティビティ、多変量テスト（MVT）、エクスペリエンスのターゲット設定（XT） アクティビティ、推奨事項、およびAutomated Personalization（AP）アクティビティの説明
* ビジネス目標を達成するために最適なアクティビティタイプを選択する
* すべてのアクティビティタイプに共通の基本的なワークフローを記述する

## 対象オーディエンス

* ビジネス従事者

>[!VIDEO](https://video.tv.adobe.com/v/30014/?captions=jpn&quality=12)
