...
最適化基準の「個別訪問者コンバージョン率を最大化」は、指標値が正の訪問者数を指します。 例えば、コンバージョン率が売上高と定義されている場合、「個別訪問者コンバージョン率を最大化」の基準は、売上高が 0 より大きい個別訪問者の数に関して最適化されます。 つまり、この条件は、売上高自体の価値ではなく、売上高を生み出す訪問者の数を最大化します。
