...
TQID: https://experienceleague.adobe.com/wPxeWJtM1tG-l1oUhE8ijTcky-mn2GE9IjNPciQTp20
...
# Adobe TargetとAdobe Analyticsの統合

このビデオでは、次の方法を学びます。

* AnalyticsとTarget リクエストがSDIDを使用してどのようにバインドされるかを説明します
* Adobe Target（A4T）を使用したAdobe Analyticsの実装要件について説明します
